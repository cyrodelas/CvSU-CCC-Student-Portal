...
<body style="background-color: #ffffff">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <div class="" style="background-image: url(<?php echo base_url();?>/assets/images/watermark.jpg); background-repeat: no-repeat;background-attachment: fixed;background-position: center;">
                        ...
                        <div class="col-md-12">
                            <?php foreach ($feeData as $feeRow){ ?>
                                <table class="table table-bordered table-responsive col-md-12">
                                    ...
                                    <tr>
                                        <td class="parent">
                                            <table class="table" style="background-color: transparent; border: 0px">
                            ...
                            <p>
                                NOTE: THIS ELECTRONIC COPY OF REGISTRATION FORM IS INTENDED FOR VIEWING PURPOSE ONLY.
                                <span class="pull-right">STUDENT PORTAL - CAVITE STATE UNIVERSITY CAVITE CITY CAMPUS</span>
                            </p>
