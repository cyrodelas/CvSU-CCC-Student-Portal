...
<div class="container body">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>Curriculum Courses <small><?php echo $schoolyear;?> Curriculum</small></h2>
                ...
                <div class="card-body">
                    ...
                    <form method="post" id="frm_validation" action="<?php echo base_url();?>file_management/add_course" data-toggle="validator" class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="row" style="margin: 20px 0 20px -10px">
                            <div class="col-md-5">
                                ...
                                <select id="coursecode" name="coursecode" class="form-control col-md-12 col-xs-12" onchange="myFunction(this)">
                                    <option hidden>----------------------------------------------------</option>
                                    <?php foreach ($csData as $csRow) { ?>
                                        <option value="<?php echo $csRow->courseCode; ?>"><?php echo $csRow->courseTitle; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col-md-5">
                                <label>Major</label>
                                <select id="major" name="major" class="form-control col-md-12 col-xs-12">
                                    <option hidden>----------------------------------------------------</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <button style="margin-top: 23px;" type="submit" class="btn btn-success col-md-12 col-xs-12">Add Course</button>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        if($pData){
                            foreach ($pData as $rs) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rs->coursemajor?></td>
                                    <th>
                                        <a href="<?php echo base_url();?>file_management/subject/<?php echo $schoolyear; ?>/<?php echo $rs->id; ?>" ><i class="fa fa-eye"></i> view </a>
                                        |
                                        <a href="" ><i class="fa fa-pencil"></i> delete </a>
                                    </th>
                                </tr>
                            <?php }}?>
                        </tbody>
...
<script type="text/javascript">
    ...
    function myFunction(obj)
    {
        ...
        var coursecode = dropDown.options[dropDown.selectedIndex].value;
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>file_management/getCourseMajor",
            data: { 'coursecode': coursecode  },

            success: function(data){
                console.log(data);
                $('#major').append('<option>N/A</option>');
                var opts = $.parseJSON(data);
                $.each(opts, function(i, d) {
                    $('#major').append('<option>' + d.majorCourse + '</option>');
                });
            }
        });
    }
